...
baseDir = '../data/my' #data directory
objName = 'jar' #object name (should correspond to a dir in data)
...
dX = 450 #calibration plane length in x direction
dY = 350 #calibration plane length in y direction
...
firstFrame = os.path.join(baseDir, objName, 'frame_111.png')

print('directory is ',firstFrame)
